    ...
    switch (term) {
        case "prelim":
            projectsContainer.innerHTML = `
                ...
                <embed src="/Project_Compilation_Ibarra/01elmsAct2-micro.pdf" type="application/pdf" width="100%" height="600px" />
                <br>
                <h2>02 eLMS Activity 2</h2>
                <embed src="/Project_Compilation_Ibarra/Ibarra-02elmsAct2-Microprocessors.pdf" type="application/pdf" width="100%" height="600px" />
                <br>
                <h2>02 Task Performance 1</h2>
                <embed src="/Project_Compilation_Ibarra/02TP-micro.pdf" type="application/pdf" width="100%" height="600px" />
                `;
            break;
        case "midterm":
            projectsContainer.innerHTML = `
                ...
                <img src="Project_Compilation_Ibarra/1.png" alt="Prelim Image" width="100%" />
                <img src="Project_Compilation_Ibarra/2.png" alt="Prelim Image" width="100%" />
                <img src="Project_Compilation_Ibarra/3.png" alt="Prelim Image" width="100%" />
                <img src="Project_Compilation_Ibarra/4.png" alt="Prelim Image" width="100%" />
            `;
            break;
        case "pre-finals":
            projectsContainer.innerHTML = `
